    ...
    <>
      <div className="lg:hidden px-4 pt-4">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-text shadow-soft"
    ...
    {mobileOpen && (
        <>
          ...
          <aside
            ...
            className="fixed left-0 top-14 z-40 h-[calc(100vh-56px)] w-[88vw] max-w-xs overflow-y-auto border-r border-border bg-card p-4 shadow-xl lg:hidden"
        >
