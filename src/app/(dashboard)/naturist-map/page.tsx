      ...
      {mapError ? (
        ...
        <div className="grid min-h-0 flex-1 gap-4 px-5 pb-5 sm:px-6 sm:pb-6 lg:grid-cols-[minmax(0,2.6fr)_minmax(21rem,1fr)]">
          ...
          <aside className="flex min-h-0 flex-col gap-3">
            <div className="flex min-h-0 flex-1 flex-col rounded-2xl border border-white/25 bg-[#0b1a2e]/80 p-3 backdrop-blur-md sm:p-4">
              <h3 className="text-sm font-semibold text-text-strong">Community snapshot</h3>
              <p className="mt-1 text-xs text-muted">
                {mode === "Explorer" ? "Option 1: map-first layout with a compact activity rail." : "Creator mode: click on the map or search to drop a new location."}
              </p>
