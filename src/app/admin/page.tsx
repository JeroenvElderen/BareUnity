...
const sections = [
  {
    ...
    description:
      "Review onboarding applications and approve or reject new members.",
  ...
  },
  {
    title: "User feedback",
    description:
      "Read ideas, bug reports, and questions sent from the floating in-app feedback bubble.",
    href: "/admin/feedback",
    cta: "Open feedback",
  },
  {
    title: "User reports",
    description:
      "Track flagged posts and comments that need moderation follow-up.",
    href: "/admin/reports",
    cta: "Open reports",
  },
  {
  ...
  },
  {
    ...
    description:
      "Add hotels, campings, and resorts without redeploying by writing directly to the stays data store.",
    href: "/admin/stays",
    cta: "Add stay",
  },
  {
  ...
  },
  {
    ...
    description:
      "Review member-requested map locations, then create approved markers and stay follow-ups.",
